...
export function leadTimeProximityFactor(lead: Pick<Lead, "intended_transaction_date" | "transaction_timeframe">): number {
  ...
  switch (lead.transaction_timeframe) {
    ...
    case "1_month": return 0.9;
    case "3_months": return 0.75;
    case "6_months": return 0.6;
    case "12_months": return 0.45;
    default: return 0.7; // unspecified/unset: neutral, no penalty for missing timeline data
  }
}

/** Base behavioural intent (0-100, usually from the latest AI analysis) blended with time-proximity. */
export function effectiveIntentScore(baseIntentScore: number, lead: Pick<Lead, "intended_transaction_date" | "transaction_timeframe">): number {
