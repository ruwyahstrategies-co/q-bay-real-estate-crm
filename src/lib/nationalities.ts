...
export const NATIONALITIES = [
  ...
  "Emirati", "English", "Equatorial Guinean", "Eritrean", "Estonian", "Ethiopian", "Fijian",
  ...
  "Ivorian", "Jamaican", "Japanese", "Jordanian", "Kazakhstani", "Kenyan", "Kittitian", "Kuwaiti",
  ...
  "Moldovan", "Monacan", "Mongolian", "Montenegrin", "Moroccan", "Mosotho", "Mozambican",
  ...
  "Russian", "Rwandan", "Salvadoran", "Samoan", "Saudi", "Scottish", "Senegalese", "Serbian",
  ...
  "Venezuelan", "Vietnamese", "Welsh", "Yemeni", "Zambian", "Zimbabwean", "Other",
] as const;
