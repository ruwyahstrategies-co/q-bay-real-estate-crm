...
-- Data API grants (Supabase grants no default privileges on public schema).
...
-- edge_rate_limits: intentionally no client-facing policy (service role only).
alter table public.edge_rate_limits enable row level security;

-- =============================================================================
-- 5. updated_at trigger for pipeline_stages
-- =============================================================================
